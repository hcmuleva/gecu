...
function isReactElement(node) {
  return (0, import_react.isValidElement)(node) && !(0, import_react_is.isFragment)(node);
}
var import_react, import_react_is, fillRef, composeRef, useComposeRef, supportRef, supportNodeRef, getNodeRef;
var init_ref = __esm({
  "node_modules/rc-util/es/ref.js"() {
    init_typeof();
    ...
    getNodeRef = Number(import_react.version.split(".")[0]) >= 19 ? (
      // >= React 19
      function(node) {
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ZF3OK4AL.js.map
